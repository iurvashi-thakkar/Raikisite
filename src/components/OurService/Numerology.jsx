    ...
    return (
        <div className='w-full md:flex md:justify-between md:px-[40px] md:mt-[200px] mt-[100px]'>
            ...
            <div className='md:block hidden'>
                ...
                <button className='px-[40px] py-[13px] bg-[#8777D7] w-max rounded-lg text-white font-bold md:mt-[69px] mx-auto md:mx-0 mt-5'>Calculate Your Birth Number</button>
            </div>
            ...
            <button className=' px-[60px] py-[13px] bg-[#8777D7] w-max rounded-lg text-white font-bold  mx-auto  md:hidden block mt-10'>Calculate Your Birth Number</button>
        </div>
    )
}
