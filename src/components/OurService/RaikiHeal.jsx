...
const RaikiHeal = () => {
    return (
        <div className='w-full md:flex md:justify-between md:px-[40px] md:mt-[200px] mt-[100px]'>
            <img src={about5} alt="numerologylogo" className='md:w-[545px] md:h-[467px] md:block hidden mr-[90px]' />
            <h3 className='md:hidden block font-[600px] text-2xl text-center'>Raiki Healing</h3>
            <div className='md:block hidden'>
                <h3 className='text-5xl font-bold '>Raiki Healing</h3>
                ...
                <Link to="/raikiheal"><button className='px-[40px] py-[13px] bg-[#8777D7] w-max rounded-lg text-white font-bold md:mt-[69px] mx-auto md:mx-0 mt-5'>See More</button></Link>
            </div>
            <div className='md:hidden flex justify-between mx-[20px]'>
                <img src={about5} alt="numerologylogo" className=' w-[205px] h-[209px]' />
            ...
            <Link to="/raikiheal"><button className=' px-[140px] py-[13px] bg-[#8777D7] w-max rounded-lg text-white font-bold  mx-auto  md:hidden block sm:mt-10'>See More</button></Link>
        </div>
    )
}
